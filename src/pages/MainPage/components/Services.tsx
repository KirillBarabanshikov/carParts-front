        ...
        <Box width={{ base: '100%', lg: '505px' }}>
          <Box mb={'50px'}>
            <Heading as={'h6'} fontSize={'18px'} color={'orange.500'} mb={'12px'}>
              Почему ввоз автозапчастей из Китая?
            </Heading>
            <Text mb={'12px'}>
          ...
          <Box>
            ...
            <Text mb={'12px'}>
              Автозапчасти из Китая приобретаются на аукционах страховых компаний. На этих аукционах
              цена снижается на половину даже из-за незначительных повреждений. Учитывая затраты на
              покупку, доставку, таможенные пошлины и восстановительный ремонт, стоимость
              аналогичной запчасти в России может быть выше на 35-50%, а цены на новые запчасти
              могут оказаться просто непомерными.
            </Text>
          </Box>
        </Box>
        <Stack flex={'1'}>
          ...
          >
            ...
            <Box>
              ...
              <Text fontSize={{ base: '16px', lg: '18px' }}>
                Прохождение таможенного оформления
              </Text>
            </Box>
          </Box>
          <Box
          ...
          >
            ...
            <Box>
              ...
              <Text fontSize={{ base: '16px', lg: '18px' }}>Комплексный ремонт на СТО</Text>
            </Box>
          </Box>
          <Box
            borderWidth={'2px'}
          ...
          >
            ...
            <Box>
              ...
              <Text fontSize={{ base: '16px', lg: '18px' }}>Услуга предоставляется по желанию</Text>
            </Box>
          </Box>
        </Stack>
      </Flex>
